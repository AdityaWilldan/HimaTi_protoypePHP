    ...
    <section class="">
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
                ...
                <?php $i = 1; ?>
                <?php foreach ($artikel as $posting): ?>
                    <div>
                    <img class="object-cover object-center w-full h-64 rounded-lg lg:h-80" src="img/<?php echo $posting["gambar"]; ?>" onerror="this.onerror=null; this.src='https://i.pinimg.com/originals/77/c7/01/77c701da8e4c052f89258d83820ea39b.png';" alt="" width="80">
                        ...
                        <div class="mt-8">
                            ...
                            <?php echo $posting['npm'] ?>
                            </p>
    
                            <div class="flex items-center justify-between mt-4">
                                <div>
                                    <a href="#" class="text-lg font-medium text-sky-700 dark:text-sky-300 hover:underline hover:text-blue-500">
                                    <?php echo $posting['prodi'] ?>
                                    </a>
    
                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo $posting['email'] ?></p>
                                </div>
    
                                <a href="singlepost.php?id=<?php echo $posting['id']; ?>" class="inline-block text-blue-500 underline hover:text-blue-400">Read More</a>
